export const times = [
  {
    ...
    time: "00:00:00.000Z",
    //here the searchTimes indicates the possible times with 30 mins intervals
    // which might be available for booking, if no other bookings were made.
    //basically looking for +1 to -1 hours of the required time. and then which are feasible.
